...
/** Flip an image along its horizontal axis
  */
def flipHorizontal(image1: BufferedImage): BufferedImage = {
  val image = image1
...
/** Flip an image along its vertical axis
  */
def flipVertical(image1: BufferedImage): BufferedImage = {
  val image = image1
...
/** Rotate an image 90 degrees clockwise
  */
def rotateRight(image1: BufferedImage): BufferedImage = {
  val image = image1
...
/** Rotate an image 90 degrees counter-clockwise
  */
def rotateLeft(image1: BufferedImage): BufferedImage = {
  val image = image1
...
/** Convert an image to grayscale
  */
def grayscale(image1: BufferedImage): BufferedImage = {
  val image = image1
